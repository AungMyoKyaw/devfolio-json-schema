...
import { WorkSchema, ProjectSchema, AchievementSchema, VolunteerSchema } from './professional';
import { EducationSchema, MOOCSchema, CertificationSchema, AwardSchema } from './education';
import { SkillSchema, LanguageSchema, InterestSchema } from './skills';
import { PublicationSchema, SpeakingSchema, MediaSchema, PatentSchema, ReferenceSchema } from './social';
...
export const DevFolioSchema = z.object({
  ...
  $schema: z.string().default('https://github.com/AungMyoKyaw/devfolio-json-schema/v1.0.0'),
