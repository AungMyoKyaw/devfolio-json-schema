...
export const sampleDevFolio: DevFolio = {
  ...
  basics: {
    ...
    summary:
      "Passionate full-stack developer with 8+ years of experience building scalable web applications and cloud-native solutions. Expertise in TypeScript, React, Node.js, and AWS. Strong advocate for clean code, test-driven development, and continuous learning.",
    location: {
  ...
  work: [
    ...
    },
    {
      ...
      endDate: "2020-02-28",
      summary:
        "Full-stack development for a B2B SaaS platform. Built features from conception to deployment in an agile environment.",
      highlights: [
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "Scalable e-commerce platform built with microservices architecture, handling inventory, orders, payments, and user management",
      highlights: [
  ...
  interests: [
    {
      ...
      level: "passionate",
      description:
        "Active contributor to open-source projects, particularly in the TypeScript and React ecosystems"
    },
    {
      name: "Photography",
      ...
      level: "hobby",
      description:
        "Amateur photographer with focus on urban landscapes and street photography"
    },
    {
      name: "Hiking",
  ...
  achievements: [
    {
      ...
      summary:
        "Recognized for developing innovative microservices architecture that improved system performance by 60%",
      category: "innovation",
    ...
    },
    {
      ...
      summary:
        "Ranked among top 5 contributors for the year with 50+ merged pull requests",
      category: "technical"
    }
  ],
  ...
  awards: [
    {
      ...
      summary:
        "Awarded for outstanding academic performance and contribution to the computer science department",
      category: "academic",
  ...
  publications: [
    {
      ...
      type: "blog-post",
      summary:
        "A comprehensive guide to building production-ready microservices using TypeScript, covering architecture patterns, testing strategies, and deployment practices",
      keywords: [
        "Microservices",
        "TypeScript",
        "Node.js",
  ...
  speaking: [
    {
      ...
      description:
        "Exploring modern development practices using TypeScript across the full stack",
      audienceSize: 300,
  ...
  volunteer: [
    {
      ...
      startDate: "2021-01-01",
      summary:
        "Mentor aspiring developers from underrepresented communities in web development and career guidance",
      highlights: [
  ...
  references: [
    {
      name: "Sarah Johnson",
      reference:
        "Aung is an exceptional developer and team lead. His technical expertise in TypeScript and cloud architecture, combined with his mentoring abilities, make him invaluable to any team. He consistently delivers high-quality solutions while fostering a collaborative environment.",
